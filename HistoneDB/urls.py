...
#this section was substituted by a recommended way to do it since django 1.8, and was shifted to browse/urls.py
...
#)
#This is not needed if STATIC dirs are properly configured
