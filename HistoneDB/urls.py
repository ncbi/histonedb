...
urlpatterns = patterns('browse.views',
    ...
    url(r'^$', 'browse_types'),
    url(r'^browse/$', 'browse_types', namespace="browse_types"),

    url(r'^type/([a-zA-Z0-9]+)/$', 'browse_variants', namespace="browse_variants"),
    url(r'^variant/([a-zA-Z0-9\.]+)/$', 'browse_variant', namespace="browse_variant"),

    url(r'^search/$', 'search', namespace="search"),
    url(r'^upload/$', 'upload', namespace="upload"),
