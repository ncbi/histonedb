	...
	if query is None:
        ...
        if "search" in parameter:
            ...
            try:
                ...
                try:
                    Sequences.objects.get(id=valuu)
			...
			# Go to histone browse page
                        ...
                        return Sequences.objects.filter(variant__core_type=core_type)
		    ...
		    pass
                ...
                try:
                    ...
                    if brand_toolbar:
                        ...
                        return Sequences.objects.filter(variant=variant)
                ...
                return Sequences.objects.filter(header__conta  
	fields = [
