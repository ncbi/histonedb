    ...
    def handle_noargs(self, **options):
        ...
        ###########
            ...
            if db_engine.endswith('sqlite3'):
                ...
                cmd = """cat %s | pv | mysql --local-infile -h %s -u %s -p%s %s -e "SET FOREIGN_KEY_CHECKS=0; SET UNIQUE_CHECKS = 0;SET SESSION tx_isolation='READ-UNCOMMITTED'; LOAD DATA LOCAL INFILE '/dev/stdin' INTO TABLE djangophylocore_%s FIELDS TERMINATED BY '|'; SET UNIQUE_CHECKS = 1; SET FOREIGN_KEY_CHECKS = 1; SET SESSION tx_isolation='READ-REPEATABLE';" """ % (
