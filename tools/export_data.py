...
with open(os.path.join(settings.STATIC_ROOT, "browse", "dumps", "{}.txt".format('seqs')),'w') as f:
...
with open(os.path.join(settings.STATIC_ROOT, "browse", "dumps", "{}.txt".format('scores')),'w') as f:
